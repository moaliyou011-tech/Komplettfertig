...
const CHECKOUT_URL =
  "https://www.checkout-ds24.com/product/696359/?voucher=KAPITALINTENSIV";
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1000, margin: "0 auto", lineHeight: 1.8 }}>
        ...
        <h2>
          Urheberrecht und Markenschutz, Haftung für die Inhalte und
        ...
        <p>
          ...
          <br />
          Aike Vaqué (Vorstandsvorsitzender), Gerrit Heyde
        </p>

        <p>
          <strong>Aufsichtsratvorsitzender:</strong>
          <br />
          Jan von Ploetz
        </p>
        ...
        <p>
          ...
          <br />
          Registernummer: HRB 42632
          <br />
          Umsatzsteuer-Identifikationsnummer gemäß § 27 a Umsatzsteuergesetz:
          DE257265676
          <br />
          Inhaltlich Verantwortlicher gemäß § 55 Abs. 2 RStV: Aike Vaqué
        </p>

        <h2>Zuständige Aufsichtsbehörde</h2>
        <p>
          Zuständige Aufsichtsbehörde für die Tätigkeit nach §§ 34c, d, f, i
          GewO:
          <br />
          ...
          <br />
          <a
            href="https://www.ihk.de/bremen-bremerhaven/"
            style={{ color: "#facc15" }}
          >
        ...
        <p>
          Alle Texte, Bilder, Grafiken, Multimediadateien sowie das Layout der
          Webseite von wika unterliegen den Gesetzen zum Schutz geistigen
          Eigentums, insbesondere dem Urheberrecht. Eine Weiterverwertung, in
          welcher Form auch immer, bedarf der ausdrücklichen Zustimmung der
          wika.
        </p>

        <h2>Tätigkeitsart</h2>
        <p>
          Maklererlaubnis (Immobilien- und Darlehensvermittlung)
          <br />
          Erlaubnis nach § 34c erteilt durch die IHK Oldenburg
        </p>

        <p>
          Versicherungsmakler mit Erlaubnispflicht nach § 34 d Abs. 1 GewO
          <br />
          Vermittlerregisternummer: D-0NCZ-RA0RQ-07
        </p>

        <p>
          Finanzanlagenvermittler mit Erlaubnispflicht nach § 34 f Abs. 1 GewO
          <br />
          wika Dienstleistungs GmbH
          <br />
          Vermittlerregisternummer gem. 34f: D-F-161-9D11-19
        </p>

        <p>
          Immobiliardarlehensvermittler mit Erlaubnispflicht nach § 34 i Abs. 1
          S. 1 GewO
          <br />
          Vermittlerregisternummer: D-W-161-GG11-35
        </p>
        ...
        <p>
          ...
          10178 Berlin
          <br />
          Tel: +49 180 500 585 0 (14 Cent/Minute aus dem dt. Festnetz, höchstens
          42 Cent/Minute aus Mobilfunknetzen)
          <br />
          <a
        ...
        <p>
          Die Gesellschaft hält keine unmittelbaren oder mittelbaren
          Beteiligungen von mehr als 10% der Stimmrechte oder des Kapitals an
          einem Versicherungsunternehmen. Ein Versicherungsunternehmen hält
          keine mittelbaren oder unmittelbaren Beteiligungen von mehr als 10%
          der Stimmrechte oder des Kapitals an der Gesellschaft.
        </p>
        ...
        <p>
          ...
          <br />
          <a href="http://www.pkv-ombudsmann.de" style={{ color: "#facc15" }}>
            http://www.pkv-ombudsmann.de
          </a>
        </p>

        <h2>Haftung für die Inhalte</h2>
        <p>
          Die Webseiten der wika werden permanent gepflegt. Sie werden mit
          größtmöglicher Sorgfalt erstellt. Die wika übernimmt keinerlei
          Garantie oder Haftung hinsichtlich der Aktualität, Vollständigkeit und
          Richtigkeit der zur Verfügung gestellten Informationen. Die wika
          behält sich das Recht vor, Ergänzungen und / oder Änderungen der zur
          Verfügung gestellten Informationen vorzunehmen.
        </p>

        <h2>Distanzierungserklärung</h2>
        <p>
          Die wika ist als Inhaltsanbieter nach § 6 Abs.1
          Mediendienste-Staatsvertrag für die eigenen Inhalte, die sie zur
          Nutzung bereithält, nach den allgemeinen Gesetzen verantwortlich. Von
          diesen eigenen Inhalten sind Querverweise auf die von anderen
          Anbietern bereitgehaltenen Inhalte zu unterscheiden.
        </p>

        <p>
          Bei Links handelt es sich stets um lebende dynamische Verweisungen.
          Die wika hat bei der erstmaligen Verknüpfung zwar den fremden Inhalt
          daraufhin überprüft, ob durch ihn eine mögliche zivilrechtliche oder
          strafrechtliche Verantwortlichkeit entsteht. Sie überprüft aber die
          Inhalte, auf die sie in ihrem Angebot verweist, nicht ständig auf
          Veränderungen, die eine Verantwortlichkeit neu begründen könnten. Wenn
          ...
          zivil- oder strafrechtliche Verantwortlichkeit auslöst, wird sie den
